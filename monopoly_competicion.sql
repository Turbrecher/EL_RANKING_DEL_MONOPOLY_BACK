...
--
-- Estructura de tabla para la tabla `puntuacion_partida`
--

CREATE TABLE `puntuacion_partida` (
...
--
-- Estructura de tabla para la tabla `puntuacion_torneo`
--
...
INSERT INTO `torneo` (`id`, `nombre`, `fecha_inicio`, `fecha_fin`) VALUES
(1, 'Torneo 2023', '2023-01-01', '2023-12-31');
...
--
ALTER TABLE `puntuacion_partida`
  ADD PRIMARY KEY (`nick_jugador`,`id_partida`),
  ADD KEY `fk_foreign_key_id_partida` (`id_partida`);

--
-- Indices de la tabla `puntuacion_torneo`
--
ALTER TABLE `puntuacion_torneo`
  ADD PRIMARY KEY (`id_torneo`,`nick_jugador`),
  ADD KEY `fk_foreign_key_nick` (`nick_jugador`);
...
--
-- Filtros para la tabla `puntuacion_partida`
--
ALTER TABLE `puntuacion_partida`
...
--
-- Filtros para la tabla `puntuacion_torneo`
--
ALTER TABLE `puntuacion_torneo`
  ADD CONSTRAINT `fk_foreign_key_id_torneo` FOREIGN KEY (`id_torneo`) REFERENCES `torneo` (`id`),
  ADD CONSTRAINT `fk_foreign_key_nick` FOREIGN KEY (`nick_jugador`) REFERENCES `jugador` (`nick`);
COMMIT;
